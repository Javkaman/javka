...
public class SudokuRozwiazanie {

    private Integer[][] board;

    public SudokuRozwiazanie(Integer[][] board) {
        this.board = board;
    }

    public static SudokuRozwiazanie sampleBoard() {
        ...
        return new SudokuRozwiazanie(board);
    }

    public static void main(String[] args) {
        SudokuRozwiazanie sampleBoard = sampleBoard();
